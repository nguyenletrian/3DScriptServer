...
class Navigation(QWidget):
    ...
    def update(self, user):
        ...
        self.login_button.setVisible(
            not logged_in
        )

        self.register_button.setVisible(
            not logged_in
        )

        self.dashboard_button.setVisible(
            logged_in
        )

        self.apps_button.setVisible(
            logged_in
        )

        self.users_button.setVisible(
            logged_in
            and user.get("role") == "admin"
        )

        self.logout_button.setVisible(
            logged_in
        )