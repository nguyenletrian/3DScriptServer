PAGE_CONFIG = {
    "name": "coffee_categories", "title": "Categories", "endpoint": "/coffee/categories", "list": {"data_key": "categories", "columns": [{"name": "id", "label": "ID"}, {"name": "name", "label": "Name"}, {"name": "status", "label": "Status"}], "actions": ["edit", "delete"]},
