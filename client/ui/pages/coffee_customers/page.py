PAGE_CONFIG = {
    "name": "coffee_customers", "title": "Customers", "endpoint": "/coffee/customers", "list": {"data_key": "customers", "columns": [{"name": "id", "label": "ID"}, {"name": "name", "label": "Name"}, {"name": "phone", "label": "Phone"}, {"name": "note", "label": "Note"}], "actions": ["edit", "delete"]},
